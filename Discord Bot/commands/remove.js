...
module.exports = {
	data: new SlashCommandBuilder()
		.setName("remove")
		.setDescription("Remove all unviewed movies from servers list if no movie specified or remove specific movie.")
		.addStringOption((option) => option.setName("movie").setDescription("Movie name or IMDB link of movie to remove from list of unviewed movies.")),
	async execute(interaction, main, settings) {
		...
		const searchOptions = main.searchMovieDatabaseObject(interaction.guild.id, movieSearch, true);
